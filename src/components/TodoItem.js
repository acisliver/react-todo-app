...
const TodoItem = React.memo(({id, title, completed, todoData, setTodoData, provided, snapshot, handleClick}) => {
    ...
    return (
        ...
        >
            <div className="items-center">
                ...
                <span
                    className={`${completed ? "line-through" : undefined} pl-1`}>{title}</span>
            </div>
            <div className="items-center">
